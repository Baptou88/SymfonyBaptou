 ...
 */
final class Version20211030085817 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE project_documents (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, doc_file VARCHAR(255) DEFAULT NULL, doc_name VARCHAR(255) DEFAULT NULL, doc_size VARCHAR(255) DEFAULT NULL, update_at DATETIME DEFAULT NULL --(DC2Type:datetime_immutable)
        )');
