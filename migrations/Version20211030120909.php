 ...
 */
final class Version20211030120909 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project_documents ADD COLUMN doc_file VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE project_documents (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, doc_name VARCHAR(255) DEFAULT NULL, doc_size VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL --(DC2Type:datetime_immutable)
        )');
        $this->addSql('INSERT INTO project_documents (id, doc_name, doc_size, updated_at) SELECT id, doc_name, doc_size, updated_at FROM __temp__project_documents');
