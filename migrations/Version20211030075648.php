 ...
 */
final class Version20211030075648 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles CLOB NOT NULL COLLATE BINARY --(DC2Type:json)
        , password VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO user (id, email, roles) SELECT id, username, roles FROM __temp__user');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO user (id, username, roles) SELECT id, email, roles FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
