 ...
 */
final class Version20211028160453 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__project AS SELECT id, type_project_id, client_id, code, created_at, modified_at FROM project');
        ...
        , description VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_2FB3D0EEB6EC9B9 FOREIGN KEY (type_project_id) REFERENCES type_project (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_2FB3D0EE19EB6921 FOREIGN KEY (client_id) REFERENCES client (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO project (id, type_project_id, client_id, code, created_at, modified_at) SELECT id, type_project_id, client_id, code, created_at, modified_at FROM __temp__project');
